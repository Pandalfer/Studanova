      ...
      >
        <div className="card-dark rounded-2xl shadow-xl p-8 space-y-6">
          <div className="text-center space-y-2">
            <h1 className="text-3xl font-bold tracking-tighter text-main-dark">
              Welcome Back
            </h1>
            ...
            <div className="space-y-3 text-body-dark">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-muted-dark hover:text-body-dark cursor-pointer"
